...
}else if($currentFileName == "reclamations" || $currentFileName == "view-reclamation")
{
	$pages["problems"] = "active";
	$pages["other"] = "hover show";
}else if($currentFileName == "stagiaires-de-groupe")
{
	$pages['my-groupe'] = "active";
	$pages["other"] = "hover show";
}else if($currentFileName == "entretiens" || $currentFileName == "view-entretien")
{
...
?>
<div class="menu-item">
	<a class="menu-link <?php echo isset($pages["engagements"]) ? $pages["engagements"] : ''; ?>" href="dashboard">
	...
	<div data-kt-menu-trigger="click" class="menu-item menu-accordion <?php echo isset($pages["engagements"]) ? $pages["engagements"] : ''; ?>">
		<span class="menu-link">
			...
			<span class="menu-title">Mon Groupe</span>
			<span class="menu-arrow"></span>
		</span>
		<div class="menu-sub menu-sub-accordion menu-active-bg">
			<div class="menu-item ">
				<a class="menu-link <?php echo isset($pages["my-groupe"]) ? $pages["my-groupe"] : '' ?>" href="stagiaires-de-groupe">
					<span class="menu-icon">
						<span class="svg-icon svg-icon-1">
							<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
					...
					<span class="menu-title">Stagiaires de groupe</span>
				</a>
			</div>
			<div class="menu-item">
				<a class="menu-link <?php echo isset($pages["problems"]) ? $pages["problems"] : '' ?>" href="reclamations">
					<span class="menu-icon">
						<span class="svg-icon svg-icon-1">
							<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
<div class="menu-item">
	...
	<a class="menu-link <?php echo isset($pages["message"]) ? $pages["message"] : ''; ?>" href="mes-messages">
		<span class="menu-icon">
			<span class="svg-icon svg-icon-1">
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
