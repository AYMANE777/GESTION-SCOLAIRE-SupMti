...
if(!$entretien){
    die("Erreur : aucun entretien trouvé.");
}
                ...
                <div class="col-md-6 col-xl-4">
                    <a href="#" class="card border-hover-primary">
                        ...
                        <div class="card-body p-9">
                            ...
                            <div class="fs-3 fw-bolder text-dark"><?php echo isset($entretien['subject']); ?></div>
                            <p class="text-gray-400 fw-bold fs-5 mt-1 mb-7"><?php echo isset($entretien['description']); ?></p>
                            <div class="d-flex flex-wrap mb-5">
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-7 mb-3">
                                    <div class="fs-6 text-gray-800 fw-bolder"><?php echo dateToFrench(isset($entretien['date_entretien']), "l j F Y"); ?></div>
